...
import parrots.indextts.BigVGAN.activations as activations
...
class AMPBlock1(torch.nn.Module):
    def __init__(self, h, channels, kernel_size=3, dilation=(1, 3, 5), activation=None):
        ...
        if self.h.get("use_cuda_kernel", False):
            from parrots.indextts.BigVGAN.alias_free_activation.cuda.activation1d import Activation1d
        else:
            from parrots.indextts.BigVGAN.alias_free_torch import Activation1d
